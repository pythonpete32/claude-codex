import type { LogEntry, Logger, MessageContent } from "@claude-codex/types";
import { beforeEach, describe, expect, it, vi } from "vitest";
import { ParserRegistry } from "../../src/parsers/registry";
import { LogTransformer } from "../../src/transformer/log-transformer";
import type { TransformResult } from "../../src/transformer/log-transformer";
  ...
  describe("transform", () => {
    ...
    describe("error handling", () => {
      ...
      it("should handle parser exceptions gracefully", () => {
        ...
        const throwingTransformer = new LogTransformer(throwingRegistry, mockLogger);
