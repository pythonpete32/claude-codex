...
export const EditTool: React.FC<EditToolProps> = ({ toolUse, status, timestamp, toolResult, className }) => {
	...
	const formatDiffOutput = () => {
		...
		if (!diffResult) {
			return <TerminalText variant="stderr">No diff available - missing old or new content</TerminalText>
		}
