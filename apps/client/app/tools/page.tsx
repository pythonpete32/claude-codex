			...
			<div className="max-w-7xl mx-auto">
				...
				<div className="mt-12 p-6 rounded-xl border border-gray-700 bg-gray-900/50">
					...
					<div className="space-y-3 text-gray-400">
						...
						<p>
							Each component follows the hybrid schema architecture where parsers transform raw Claude Code 
							logs into UI-ready props that components can directly consume.
						</p>
						<p>
						...
						<ul className="list-disc list-inside ml-4 space-y-1">
							...
							<li>Proper TypeScript typing with no <code className="text-red-400">any</code> types</li>
