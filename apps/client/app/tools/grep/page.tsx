							...
							results={[
								{
									...
									matches: [
										...
										{ line: 20, content: "export const debounce = (fn: Function, delay: number) => {", matchStart: 0, matchEnd: 21 },
										{ line: 35, content: "export const throttle = (fn: Function, limit: number) => {", matchStart: 0, matchEnd: 21 }
									]
								},
								{
									...
									totalMatches: 2,
									matches: [
										{ line: 3, content: "export function isEmail(email: string): boolean {", matchStart: 0, matchEnd: 23 },
										{ line: 15, content: "export const validatePassword = (password: string) => {", matchStart: 0, matchEnd: 29 }
									]
								}
							]}
							ui={{
							...
							results={[
								{
									...
									totalMatches: 2,
									matches: [
										{ line: 8, content: "export const API_URL = process.env.NEXT_PUBLIC_API_URL;", matchStart: 13, matchEnd: 16 },
								...
								},
								{
									...
									totalMatches: 1,
									matches: [
										{ line: 1, content: "// API Service Layer", matchStart: 3, matchEnd: 6 }
									]
								}
							]}
							ui={{
