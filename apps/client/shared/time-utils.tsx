 ...
 */
export function formatTimestamp(timestamp: string, format: "relative" | "absolute" = "relative"): string {
 ...
 */
export const TimeDisplay: React.FC<TimeDisplayProps> = ({ timestamp, format = "relative", className }) => {
	...
	return (
		<span
			...
			title={format === "relative" ? fullDate : `${formatTimestamp(timestamp, "relative")} (${fullDate})`}
		>
			{formattedTime}
		</span>
	)
